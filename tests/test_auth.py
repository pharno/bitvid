...
class AuthTest(BaseTest):
    ...
    def test_authentication_password_incorrect(self):
        assert self.client.authenticate(self.email, "wrongpassword") is False

    def test_authentication_email_incorrect(self):
        assert self.client.authenticate(
            "wrong@email.tv", self.password) is False

    def test_totally_wrong_credentials(self):
        assert self.client.authenticate(
            "wrong@email.tv", "wrongpassword") is False
